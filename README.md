...
![tests](https://img.shields.io/badge/tests-32%20%2B%2030%20%2B%20159%20%2B%2036%20passing-4ade80)
...
| 前端 DOM 集成 | **159 / 159 通过**（含 11 屏画廊、七国齐全、字体接入、柔光扫过无硬边、背景视频渲染与省流量策略、**滚轮不被画廊抢走**、资讯已移除、验证码登录、后台新区块、配置热重载、错误框与字段高亮） |

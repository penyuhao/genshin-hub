...
![tests](https://img.shields.io/badge/tests-34%20%2B%2042%20%2B%2022%20%2B%20190%20%2B%2036%20passing-4ade80)
...
| 上传链路（`tests/uploads.mjs`） | **42 / 42 通过**（自建隔离实例：视频容器校验、伪造扩展名被拒且不留文件、Range 请求、**链接归一化**、**页面背景字段校验**、配置字段校验、回归图片上传） |
